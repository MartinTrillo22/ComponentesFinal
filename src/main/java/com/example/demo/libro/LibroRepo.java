...
public interface LibroRepo extends JpaRepository<Libro, Long> {
    ...
    @Query(" SELECT CASE WHEN COUNT(l) > 0 THEN true ELSE false END FROM Libro l WHERE l.autor = :autor AND l.id != :id")
    boolean existsByAutorAndIdNot(String autor, Long id);
